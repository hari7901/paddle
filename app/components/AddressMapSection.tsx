  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-5xl mx-auto bg-gradient-to-br from-gray-900 to-black rounded-xl shadow-2xl overflow-hidden border border-green-800"
      >
        <div className="md:flex">
          {/* Address Info */}
          <div className="md:w-1/2 p-8 bg-green-900/30 relative">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-900/0 via-green-600 to-green-900/0" />
